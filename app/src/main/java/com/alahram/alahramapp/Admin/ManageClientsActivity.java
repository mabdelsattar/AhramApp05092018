...
public class ManageClientsActivity extends AppCompatActivity {
    ...
    public static ArrayList<ClientViewModel> data = new ArrayList<>();
    ...
    protected void onResume() {
        ...
        dialog = new ProgressDialog(ManageClientsActivity.this);
        dialog.setMessage("جاري التحميل...");
        dialog.show();

        String url = Constant.serversite+"/api/AlAhram/GetClients?basedOn=1";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonItems.length(); i++)
                            {
                                ...
                                data.add(new ClientViewModel(Name,Phone));
                            }
                            ...
                            adapter = new ManageClientsAdpater(ManageClientsActivity.this, data);
                            requestrecycleview = (RecyclerView) findViewById(R.id.listview);
                            RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(ManageClientsActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //forceRTLIfSupported();
        setContentView(R.layout.activity_manage_clients);
        requestQueue = RequestQueueSingleton.getInstance(ManageClientsActivity.this)
                .getRequestQueue();
