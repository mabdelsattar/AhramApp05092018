...
public class allrequests extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // forceRTLIfSupported();
        ...
        //showdatadummy();
        data = new ArrayList<oderlist>();

        data.add(new oderlist("58", "محمد حسن علي","0584848484","19/1/2018"));
        data.add(new oderlist("60", "كريم احمد عبد الرحمن","0544484848","18/1/2018"));
        ...
        requestrecycleview.addItemDecoration(new allrequests.GridSpacingItemDecoration(2, dpToPx(10), true));
...
//        fab.setImageDrawable(willBeWhite);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(allrequests.this,RequestFormActivity.class));
